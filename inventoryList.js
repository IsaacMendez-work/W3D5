...
function inventoryList(todo,clothes) {
    if (todo = "add") {
        return inventoryList.push(clothes);
    } else if (todo = "remove") {
        return inventoryList = inventoryList.filter(v => v !== "clothes");
    } else if (todo = getList) {
        return inventoryList()
    } else {
        return alert(`Invalid command. Please use "add", "remove", or "getList."`);
    }
}
function main() {
